...
## Задание 4
### inventory.ini после шестого задания - два адреса внутренние
...
## Задание 6
Я доконца не разобрася с целью задания. Часть 1 выполнил на всех ВМ из файла inventory.ini. Часть 2 выполнил частично. Модифицированный шаблон находится в файле inventory.tftpl. Но для применения такого кода нужна еще одна ВМ бастион, поднять такую ВМ через терраформ не составляет проблемы. однако как настроить ansible через ssh proxy да еще и определить тип адреса(внешний внутренний)... Видимо эта тема следующей части обучений
